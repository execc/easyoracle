...
create table oracle_definition (id varchar(255) not null, data_source_expression varchar(255), data_source_type varchar(255), data_transformation_script varchar(255), signatures int4 not null, trigger varchar(255), window_size int4 not null, contract_id varchar(255) not null, primary key (id));
