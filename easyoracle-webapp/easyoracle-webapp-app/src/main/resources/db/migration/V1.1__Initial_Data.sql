...
create table oracle_definition (id varchar(255) not null, contract_name varchar(255), contract_id varchar(255), signatures int4 not null, trigger varchar(255), window_size int4 not null, primary key (id));
...
create unique index on oracle_task (definition_id, status) where status = 'IN_PROGRESS';